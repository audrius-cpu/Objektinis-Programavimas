...
int main()
{
    ...
    while (!tinkama_ivestis)
    {
        ...
        else if (ivestis == "G" || ivestis == "g")
        {
            int studentu_skaicius;
            int pazymiu_skaicius;
            string generuoto_failo_pavadinimas;

            cout << "Iveskite pavadinima, kuriame bus sugeneruoti duomenys: ";
            cin >> generuoto_failo_pavadinimas;
            cout << "Iveskite studentu skaiciu, kuris bus sugeneruotas: ";
            cin >> studentu_skaicius;
            cout << "Iveskite pazmymiu skaiciu, kuris bus sugeneruotas: ";
